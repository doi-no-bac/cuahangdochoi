...
<body>
    ...
    <hr />
    <h2 style="text-align: center">Quản lý trang Hàng mới </h2>
                ...
                <tr>
                    <td>
                        ...
                        if (isset($_POST['them'])) {
                            ...
                            $sql = "INSERT INTO hangmoi (msp, ha, tsp, gia, dv) VALUES (?, ?, ?, ?, ?)";
                        ...
                        <form method="post" action="">
                            ...
                            <input type="text" name="msp" placeholder="a(n+1)...." id="them_msp"><br><br>
                    ...
                    <td>
                        ...
                        if (isset($_POST['update'])) {
                            ...
                            $sql = "UPDATE hangmoi SET ha = ?, tsp = ?, gia = ?, dv=? WHERE msp = ?";
                        ...
                        <form method="post" action="">
                            ...
                            <input type="text" name="msp" placeholder="a..." id="update_msp"> <br><br>
                    ...
                    <td>
                        ...
                        if (isset($_POST['delete'])) {
                            ...
                            $sql = "DELETE FROM hangmoi WHERE msp = ?";
                        ...
                        <form method="post" action="">
                            ...
                            <input type="text" name="msp" placeholder="a..." id="delete_msp">
